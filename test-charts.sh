...
install_cruisekube_chart() {
    ...
    helm upgrade --install $RELEASE_NAME \
        ...
        --set cruisekubeController.env.CRUISEKUBE_PROMETHEUS_URL="http://localhost:9090" \
        --set cruisekubeController.env.CRUISEKUBE_PROMETHEUS_INSECURESKIPTLSVERIFY="false" \
