...
func HandleRoot(authEnabled bool) gin.HandlerFunc {
	resp := rootResponse{
		...
		Endpoints: map[string]string{
			...
			"/clusters/{clusterId}/preflight":                    "Dashboard readiness check: Prometheus connectivity, Kubernetes/node/Prometheus versions, and required-metric existence (thresholds are backend-defined; no parameters)",
