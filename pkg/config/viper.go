...
func LoadWithViperInstance(ctx context.Context, v *viper.Viper, configFilePath string) (*Config, error) {
	...
	v.SetDefault("controller.tasks.cleanup.metadata.oomEventsRetentionDays", 7)
	v.SetDefault("controller.tasks.cleanup.metadata.auditEventsRetentionDays", 7)
	v.SetDefault("controller.tasks.cleanup.metadata.snapshotsRetentionDays", 7)
