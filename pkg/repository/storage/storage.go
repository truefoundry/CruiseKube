...
func (s *Storage) DeleteStaleWorkloads(clusterID string, keepWorkloadIds []string) (int, error) {
	deleted, err := s.DB.DeleteWorkloadsNotInCluster(clusterID, keepWorkloadIds)
	if err != nil {
