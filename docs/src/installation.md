...
3. **Enable Auto-apply Recommendations Task**
    - By default, the auto-apply recommendations task is also disabled. To enable it, set the `CRUISEKUBE_CONTROLLER_TASKS_APPLYRECOMMENDATION_METADATA_DRYRUN` environment variable to `false` in your values file.
