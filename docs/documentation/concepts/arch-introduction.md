...
- **Frontend**
    - Shows recommendations and the savings you would get by switching a workload to Cruise mode
    - Lets you set per-workload configuration such as priority and mode
- **Database**
    - Holds the statistics produced by the Statistics Engine
    - Holds the per-workload configuration (priority, mode, and so on)
