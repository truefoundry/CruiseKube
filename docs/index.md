  ...
  <div class="ck-hero__inner">
    <div class="ck-hero__copy">
      ...
      <div class="ck-hero__actions">
        <a href="https://calendar.app.google/aJGRuUjSjNd15vqJ9" class="ck-btn ck-btn--dark ck-btn-icon" target="_blank" rel="noopener noreferrer">
          <svg class="ck-btn-icon__svg" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/></svg>
          Book a call
        </a>
