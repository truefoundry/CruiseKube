...
{{- default "controller" .Values.autopilotController.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- if .Values.autopilotController.fullnameOverride }}
{{- .Values.autopilotController.fullnameOverride | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- $name := default "controller" .Values.autopilotController.nameOverride }}
