...
| `cruisekubeController.image.tag`                            | CruiseKube Controller image tag (immutable tags are recommended)                                                      | `0.2.1`                              |
...
| `cruisekubeWebhook.image.tag`                                                        | CruiseKube Webhook image tag (immutable tags are recommended)                                    | `0.2.1`                                              |
...
| `cruisekubeFrontend.image.tag`                 | CruiseKube Frontend image tag (immutable tags are recommended)          | `0.2.1`                                       |
