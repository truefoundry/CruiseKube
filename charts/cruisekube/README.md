...
| Name                                                           | Description                                                                                                             | Value                                |
| -------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------ |
| `cruisekubeController.usageTelemetry.enabled`                  | Send anonymous usage heartbeats when true (requires install-id Secret and providerConfig).                              | `false`                              |
| `cruisekubeController.usageTelemetry.interval`                 | Heartbeat period (Go duration, e.g. 30m, 1h).                                                                           | `30m`                                |
| `cruisekubeController.usageTelemetry.installId.existingSecret` | If set, use this Secret for distinct install id instead of chart-created Secret.                                        | `""`                                 |
| `cruisekubeController.usageTelemetry.installId.key`            | Data key in the install-id Secret.                                                                                      | `install-id`                         |
| `cruisekubeController.usageTelemetry.providerConfig`           | Opaque map passed to the compiled-in reporter (e.g. PostHog: api_key, api_host). Serialized to JSON for the controller. | `{}`                                 |
