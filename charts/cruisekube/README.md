...
| `cruisekubeController.image.tag`                            | CruiseKube Controller image tag (immutable tags are recommended)                                                      | `0.1.10`                             |
...
| `cruisekubeWebhook.image.tag`                                                        | CruiseKube Webhook image tag (immutable tags are recommended)                                    | `0.1.10`                                             |
...
| `cruisekubeFrontend.image.tag`                 | CruiseKube Frontend image tag (immutable tags are recommended)          | `0.1.10`                                      |
