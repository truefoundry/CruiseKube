...
| `cruisekubeController.admin.existingSecret`                 | Existing Secret for HTTP basic auth. If empty, a pre-install Job creates a Secret with random credentials.          | `""`                                 |
...
| `cruisekubeController.admin.credentialGen.image.repository` | Image for the admin credential hook Job (kubectl).                                                                    | `bitnami/kubectl`                    |
| `cruisekubeController.admin.credentialGen.image.tag`        | Image tag for the admin credential hook Job.                                                                          | `1.31.4-debian-12-r4`                |
| `cruisekubeController.admin.credentialGen.image.imagePullPolicy` | imagePullPolicy for the admin credential hook Job.                                                              | `IfNotPresent`                       |
| `cruisekubeController.admin.credentialGen.resources`        | Resources for the admin credential hook Job.                                                                          | See values.yaml                      |
