...
| `cruisekubeController.image.tag`                            | CruiseKube Controller image tag (immutable tags are recommended)                                                      | `0.2.5-rc.1`                         |
...
| `cruisekubeWebhook.image.tag`                                      | CruiseKube Webhook image tag (immutable tags are recommended)                                                      | `0.2.5-rc.1`                                         |
...
| `cruisekubeWebhook.mutatingWebhookConfiguration.namespaceSelector` | Raw namespaceSelector for the mutating webhook configuration. Legacy `namespaceSelector.excludeNamespaces` was removed; use `{}` to keep the default exclusions (`kube-public`, `kube-node-lease`, `local-path-storage`), or migrate old exclude lists to `matchExpressions: [{key: "kubernetes.io/metadata.name", operator: "NotIn", values: [...]}]`. | `{}`                                                 |
...
| `cruisekubeFrontend.image.tag`                 | CruiseKube Frontend image tag (immutable tags are recommended)          | `0.2.5-rc.1`                                  |
