...
| `cruisekubeWebhook.mutatingWebhookConfiguration.namespaceSelector`                   | Raw namespaceSelector object for webhook namespace filtering; leave empty to use default namespace exclusions | `{}`                                                 |
