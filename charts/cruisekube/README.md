...
| `cruisekubeController.admin.existingSecret`                 | Name of the secret containing admin credentials.                                                                      | `""`                                 |
...
| `cruisekubeController.admin.jwtSecretKey`                   | Key in the secret for the JWT signing secret.                                                                         | `admin-jwt-secret`                   |
